...
def all_srcs(name = "all_srcs"):
    ...
    filegroup(
        name = "licenses",
        srcs = ["LICENSE", "LICENSE-APL2-Stomp-Websocket", "LICENSE-MPL-RabbitMQ"],
    )
    filegroup(
        name = "priv",
        srcs = ["priv/bunny.html", "priv/bunny.png", "priv/echo.html", "priv/index.html", "priv/main.css", "priv/pencil.cur", "priv/stomp.js", "priv/temp-queue.html"],
    )
    filegroup(
        name = "public_hdrs",
        srcs = [],
